...
function SelectionEditorComponent({spaceId}: {spaceId: string}) {
  ...
  return (
    <AppLayout>
      ...
      <Container size="xs">
        <Title order={1}>Create a new selection</Title>
...
const SelectionEditor: NextPage = () => {
  const router = useRouter()
  ...
  return (
    <SelectionEditorComponent spaceId={spaceId as string} />
  );
};
