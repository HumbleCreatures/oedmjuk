...
import { Button, Container, Text, Title, createStyles, Group, ThemeIcon, SimpleGrid } from "@mantine/core";
...
function SelectionView({
  ...
  const { alternatives, status, title, body, participants, createdAt, updatedAt, creatorId } = selection;
  ...
  return (
    <AppLayout>
      ...
      <Container size="sm" className={classes.area}>
        ...
        {selection.alternatives.length < 3 && <Text>You need three alternatives to start to vote</Text> }
        </SimpleGrid>
      </Container>
