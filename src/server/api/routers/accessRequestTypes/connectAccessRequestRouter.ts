...
export const connectAccessRequestRouter = createTRPCRouter({
    markConnectAccessRequestAsDone: protectedProcedure
    .input(
      z.object({
        stepId: z.string(),
        accessRequestId: z.string(),
        connectedAccessRequestId: z.string(),
    ...
    .mutation(async ({ ctx, input }) => {
        ...
        if(accessRequestStep.stepType !== AccessRequestStepTypes.AccessRequest) {
        ...
        const createResult = await ctx.prisma.accessRequestStepExecution.create({
            data: {
              ...
              connectedAccessRequestId: input.connectedAccessRequestId,
              done: true,
              log: input.comment,
              stepFinished: true 
            }
    ...
    markConnectAccessRequestAsFailure: protectedProcedure
    .input(
      z.object({
        stepId: z.string(),
        accessRequestId: z.string(),
    ...
    markConnectAccessRequestAsSkipped: protectedProcedure
    .input(
      z.object({
        stepId: z.string(),
        accessRequestId: z.string(),
