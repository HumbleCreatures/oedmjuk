...
export const connectCalendarEventRouter = createTRPCRouter({
    markConnectCalendarEventAsDone: protectedProcedure
    .input(
      z.object({
        stepId: z.string(),
        accessRequestId: z.string(),
        connectedCalendarEventId: z.string(),
    ...
    .mutation(async ({ ctx, input }) => {
        ...
        if(accessRequestStep.stepType !== AccessRequestStepTypes.CalendarEvent) {
        ...
        const createResult = await ctx.prisma.accessRequestStepExecution.create({
            data: {
              ...
              connectedCalendarEventId: input.connectedCalendarEventId,
              done: true,
              log: input.comment,
              stepFinished: true 
            }
    ...
    markConnectCalendarEventAsFailure: protectedProcedure
    .input(
      z.object({
        stepId: z.string(),
        accessRequestId: z.string(),
    ...
    markConnectCalendarEventAsSkipped: protectedProcedure
    .input(
      z.object({
        stepId: z.string(),
        accessRequestId: z.string(),
